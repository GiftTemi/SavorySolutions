namespace SavourySolutions.Services.Data.Tests
{
    ...
    public class ReviewsServiceTests : IAsyncDisposable
    {
        ...
        private SavourySolutionsUser secondSavourySolutionsUser;
        ...
        public async Task CheckIfGetReviewByIdWorksCorrectly()
        {
            ...
            var expectedModel = new ReviewListingViewModel
            {
                ...
                UserUsername = this.firstSavourySolutionsUser.UserName,
            };
        ...
        private void InitializeFields()
        {
            ...
            this.secondSavourySolutionsUser = new SavourySolutionsUser
            {
                Id = "2",
                FullName = "Incho",
        ...
        private async Task SeedUsers()
        {
            ...
            await this.usersRepository.AddAsync(this.secondSavourySolutionsUser);
