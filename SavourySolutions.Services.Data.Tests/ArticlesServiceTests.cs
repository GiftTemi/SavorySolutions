namespace SavourySolutions.Services.Data.Tests
{
    ...
    public class ArticlesServiceTests : IAsyncDisposable, IClassFixture<Configuration>
    {
        ...
        private SavourySolutionsUser SavourySolutionsUser;
        ...
        public async Task TestAddingRecipeWithMissingCategory()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<NullReferenceException>(async () => await this.articlesService.CreateAsync(model, this.SavourySolutionsUser.Id));
        ...
        public async Task TestAddingAlreadyExistingArticle()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<ArgumentException>(async () => await this.articlesService.CreateAsync(model, this.SavourySolutionsUser.Id));
        ...
        public async Task TestEditingArticleWithMissingArticle()
        {
            ...
            var exception = await Assert
                .ThrowsAsync<NullReferenceException>(async () => await this.articlesService.EditAsync(model, this.SavourySolutionsUser.Id));
        ...
        {
            this.SavourySolutionsUser = new SavourySolutionsUser
            {
                Id = "1",
        ...
        {
            await this.usersRepository.AddAsync(this.SavourySolutionsUser);
