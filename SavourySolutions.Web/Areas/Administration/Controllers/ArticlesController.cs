namespace SavourySolutions.Web.Areas.Administration.Controllers
{
    ...
    public class ArticlesController : AdministrationController
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Categories = (IEnumerable<Models.ViewModels.Categories.CategoryDetailsViewModel>)categories,
            };
        ...
        public async Task<IActionResult> Create(ArticleCreateInputModel articleCreateInputModel)
        {
            ...
            if (!this.ModelState.IsValid)
            {
                ...
                articleCreateInputModel.Categories = (IEnumerable<Models.ViewModels.Categories.CategoryDetailsViewModel>)categories;
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            articleToEdit.Categories = (IEnumerable<Models.ViewModels.Categories.CategoryDetailsViewModel>)categories;
