namespace SavourySolutions.Web.Areas.Administration.Views.Shared
{
    using System;
    using System.IO;
    ...
    public class AdminNavPages
    {
        ...
        public static string SavourySolutionsUsers => "SavourySolutionsUsers";
        ...
        public static string SavourySolutionsUsersNavClass(ViewContext viewContext) => PageNavClass(viewContext, SavourySolutionsUsers);
